...
import ethers from 'ethers'; // Use the default import for Ethers v5 in ESM
...
export const handler = async (event, context) => {
    console.log("--- processMint function invoked (v5 ESM) ---");
    ...
    try {
        ...
        if (isFreeMint) {
            ...
            if (hasUsedFreeMint) { throw new Error("Free mint already used for this wallet."); }
        }
